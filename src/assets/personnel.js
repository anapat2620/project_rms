// personnel.js
// Multi-step form, validation, progress bar, etc. (เหมือน teacher.js)
window.initPersonnelMultiStep = function() {
    ...
    document.getElementById('multi-step-form').addEventListener('submit', async function(event) {
        ...
        // รวม error ของแต่ละ step
        for (let i = 0; i < steps.length; i++) {
            if (!validateStep(i)) {
                allStepsValid = false;
                // รวม error message ของแต่ละ field ที่มี border-red-500
